---
name: testing-master
description: "Automated test strategies, unit testing, and E2E testing guidelines. / TR: Test stratejileri, birim testleri (unit test) ve e2e testler yazmak için yetenek."
metadata:
  version: 1.0.0
---
