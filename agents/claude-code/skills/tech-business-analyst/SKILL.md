...
description: "Bridges product design and UX concepts into actionable technical specifications, data models, and developer tasks. / TR: Teknik iş analizi ve gereksinim dokümanı yazmak için kullanılan yetenek."
metadata:
  version: 1.0.0
---
