...
description: "Performs pre-release system stress simulation and pre-mortem analysis ('If this system fails in production, where does it break?'). / TR: Mimari ve sistem kararlarında 'Bu sistem canlıda patlarsa nereden patlar?' analizi yapan stres testi skill'i."
alwaysApply: false
---
