...
description: "Brand identity management, logo usage, typography, color palettes, and brand rules. / TR: Marka tutarlılığını sağlamak için marka kimliği, logo kullanımı, tipografi, renk paletleri ve görsel kuralların yönetimi."
alwaysApply: false
---
