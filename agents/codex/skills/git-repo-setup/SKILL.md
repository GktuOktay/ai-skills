---
name: Git Repo Setup
description: "Community repository standards (README, CONTRIBUTING, rules, license, workflows). / TR: GitHub repo kurulumu ve topluluk standartları için en iyi uygulamalar (README, CONTRIBUTING, kurallar)."
alwaysApply: false
---
