...
description: Git commit mesajları ve branch isimlendirme standartlarını belirler. Projelerde düzenli ve anlaşılır bir tarihçe oluşturmak için Conventional Commits kurallarını uygular.
alwaysApply: false
---
