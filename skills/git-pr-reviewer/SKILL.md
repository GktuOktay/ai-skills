...
description: Pull Request (PR) oluşturma ve kod inceleme (code review) süreçleri için standartları belirler. Yapıcı geri bildirim ve birleştirme (merge) stratejilerini içerir.
alwaysApply: false
---
