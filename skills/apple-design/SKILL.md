...
description: iOS, macOS ve visionOS için Apple Human Interface Guidelines (İnsan Arayüzü Yönergeleri) tabanlı uygulama tasarımı ve geliştirme becerisi. Platform standartları, SwiftUI en iyi pratikleri, erişilebilirlik ve App Store onay süreçlerine odaklanır.
---
