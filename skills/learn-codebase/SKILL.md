...
description: Bilinmeyen veya büyük kod tabanlarını hızlıca anlama, analiz etme ve gezinme yeteneği. Mimari yapıları, veri akışını ve bağımlılıkları sistemli bir şekilde çözme stratejilerini içerir.
---
