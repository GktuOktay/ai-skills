---
name: Git Repo Setup
description: GitHub repo kurulumu ve topluluk standartları için en iyi uygulamaları sunar. README, CONTRIBUTING, kural dosyaları ve repo ayarlarını kapsar.
alwaysApply: false
---
