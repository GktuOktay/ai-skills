...
description: "Dependency vulnerability auditing (npm, pip, etc.), CVE scanning, and supply chain security. / TR: Proje bağımlılıklarındaki (npm, pip vb.) CVE zafiyetlerinin taranması, supply chain güvenliği ve versiyon güncellemeleri."
alwaysApply: false
---
