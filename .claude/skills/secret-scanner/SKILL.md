...
description: "Scans codebase for leaked API keys, credentials, certificates, and .env misconfigurations. / TR: Kod tabanında unutulmuş API key, şifre, sertifika gibi hassas verilerin taranması ve .env yönetimi."
alwaysApply: false
---
