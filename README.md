...
* ⚖️ **[Hierarchy & Delegation Protocol](docs/en/HIERARCHY_PROTOCOL.md)** 
...
* 🏗️ **[Architecture Deep-Dive](docs/en/ARCHITECTURE.md)** 
...
* 🧠 **[Core Engineering Principles](docs/en/PRINCIPLES.md)** 
...
* 🔄 **[Autonomous Workflows](docs/en/WORKFLOWS.md)** 
