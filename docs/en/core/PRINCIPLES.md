...
### ✅ Best Practice (Agent Standard Practice)
Domain driven ve CQRS mantığına uygun, sadece ihtiyaca hizmet eden (Use-Case odaklı) mimari:
```csharp
// GOOD PRACTICE: Sadece ilgili iş mantığını barındıran Handler.
...
## 2. Defensive Programming (Defensive Programming) & Fail-Fast
...
## 3. Inversion of Control (IoC) ve Testability
