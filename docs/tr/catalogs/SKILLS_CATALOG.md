...
Bu doküman, v2.0 ekosistemindeki tüm aktif orkestratörleri, uzmanları, kalite kapılarını ve iş akışlarını listeler.
...
* [Hiyerarşi ve Yetki Devri Protokolü](../core/HIERARCHY_PROTOCOL.md)
