# 🧠 Agentic Prompting ve Kullanım Kılavuzu
...
## 2. Kalite Kapılarıyla (Quality Gates) Başa Çıkmak
...
## 3. Takımlar Arası Devir Teslim (API Handoff)
...
## 4. İstisnai Durumlar: Kuralları Ezmek (Override)
